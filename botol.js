...
ovo = donate.Ovo
pulsa = donate.Pulsa
qris = donate.QrisAllPay
qrisgpy = donate.QrisGopay
...
//MESS
			mess = {
				...
				success: '_Berhasil, Jangan Lupa Support FahriBotz',
				error: {
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			botol.sendMessage(from, teks, text, { thumbnail: thumb, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `New Base By KubilBot`,body:"© Recode By FahriBotz",previewType:"PHOTO",thumbnail:thumb,sourceUrl:`https://youtube.com/c/BotolBotZ`}}})
		}
		const reply2 = (teks) => {
...
"externalAdReply": {
                ...
                "mediaType": "10",
                "mediaUrl": `https://chat.whatsapp.com/CKndX5cGh8U92aVex2bknC`,
                "thumbnailUrl": "https://youtu.be/oJPJov3kEOU",
                "thumbnail": fakeimage,
                "sourceUrl": `https://chat.whatsapp.com/CKndX5cGh8U92aVex2bknC`,
	...
	participant : '0@s.whatsapp.net'},
       message: {
              orderMessage: {
                            ...
                            orderTitle: `© Recode By FahriBotz`,
                            thumbnail: thumb, 
...
const fbotol = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `© Creator By FahriBotz`,
                 "title": `© Creator By FahriBotz`,
...
botolmastah = `sᴀᴡᴇʀɪᴀ : ${Saweria}\nʏᴏᴜᴛᴜʙᴇ : ${Yt}`
but = [{ buttonId: `${prefix}owner`, buttonText: { displayText: '👤owner' }, type: 1 },{ buttonId: `${prefix}button`, buttonText: { displayText: '🔖BUTTON' }, type: 1 }]
...
if (isBanned) return freply(mess.banned)
 ...
 buttonText: 'Click Here',
 footerText: `${fakemenu}`,
 description: `Hai Kak @${sender.split('@')[0]}👋 ${ucapanWaktu}, Silahkan Pilih Menu Donasinya\nJangan Spam Ya Kak`,
 sections: [
                     {
                      "title": `Jangan Lupa Join Group Bot`,
 rows: [
                           {                         
                               "title": "Gopay",
                               "description" :"Menampilkan Donasi/Pembayaran Gopay",
                               "rowId": `${gopay}`
                            },
                            {                         
                               "title": "Dana",
                               "description" :"Menampilkan Donasi/Pembayaran Dana",
                               "rowId": `${dana}`
                            },
                            {                         
                               "title": "Ovo",
                               "description" :"Menampilkan Donasi/Pembayaran Ovo",
                               "rowId": `${ovo}`
                            },
                            {                         
                               "title": "Pulsa",
                               "description" :"Menampilkan Donasi/Pembayaran Lewat Pulsa",
                               "rowId": `${pulsa}`
                            },
                            {                         
                               "title": "Qris AllPay",
                               "description" :"Menampilkan Donasi/Pembayaran Lewat Qris Allpay",
                               "rowId": `${QrisAllPay}`
                            },
                            {                         
                               "title": "Qris Gopay",
                               "description" :"Menampilkan Donasi/Pembayaran Lewat Qris Gopay",
                               "rowId": `${QrisGopay}`
                            },
                            {                         
                               "title": "Saweria",
                               "description" :"Menampilkan Donasi/Pembayaran Lewat Saweria",
                               "rowId": `${saweria}`
                            },
                            {                         
                               "title": "Linktree",
                               "description" :"Menampilkan Donasi/Pembayaran Lewat LinkTree",
                               "rowId": `${Linktree}`
                            },                   
                        ]
                     }],
...
│
│ > Harga Sewa :
│• Permanen: 12k (Sampe Owner Pensi)
│
│ > Pembayaran :
│• GOPAY : 
│  [Minta Owner]
│• Saweria : 
│  [https://saweria.co/FahriBotz]
╰────
Minat? Chat :
http://Wa.me/6285772674695`)
randommusic = fs.readFileSync(`./media/audio/${randomaudio}.mp3`)
...
function _0x3c53(){var _0x1c5c69=['1713900pvQrsj','6UyBrXU','80ENIMlM','94hzMpXL','14241YjoqSS','banned','2185875cHnsOD','2180066bKvrUq','2981XLHKnw','955295mfidvf','3076800yplxQo','204pZfhmD','_*SCRIPT\x20ORI\x20BY\x20Kubill\x20Bot*_\x0a\x0a•\x20*GITHUB*\x20:\x20https://cararegistrasi.com/YIq6DaTk0TL\x0a\x0a•\x20*YOUTUBE*\x20:\x20https://youtube.com/c/BotolBotZ\x0a\x0a_*SCRIPT\x20RECODE\x20BY\x20FahriBotz*_\x0a\x0a•\x20*GITHUB*\x20:\x20https://bit.ly/3j01SHR\x0a\x0a•\x20*MEDIA\x20FIRE*\x20:\x20Chat\x20Owner'];_0x3c53=function(){return _0x1c5c69;};return _0x3c53();}var _0x3870c8=_0x49a6;(function(_0x594bde,_0x1a481d){var _0x40bf52=_0x49a6,_0x133ebe=_0x594bde();while(!![]){try{var _0x3d43a7=-parseInt(_0x40bf52(0x1d6))/0x1*(parseInt(_0x40bf52(0x1d1))/0x2)+-parseInt(_0x40bf52(0x1d2))/0x3*(parseInt(_0x40bf52(0x1cc))/0x4)+parseInt(_0x40bf52(0x1ce))/0x5+-parseInt(_0x40bf52(0x1cf))/0x6*(-parseInt(_0x40bf52(0x1d5))/0x7)+parseInt(_0x40bf52(0x1d8))/0x8+parseInt(_0x40bf52(0x1d4))/0x9+-parseInt(_0x40bf52(0x1d0))/0xa*(parseInt(_0x40bf52(0x1d7))/0xb);if(_0x3d43a7===_0x1a481d)break;else _0x133ebe['push'](_0x133ebe['shift']());}catch(_0x38f6d8){_0x133ebe['push'](_0x133ebe['shift']());}}}(_0x3c53,0x31fb9));function _0x49a6(_0x15d322,_0xd71883){var _0x3c53e1=_0x3c53();return _0x49a6=function(_0x49a684,_0x12c4a5){_0x49a684=_0x49a684-0x1cc;var _0x392775=_0x3c53e1[_0x49a684];return _0x392775;},_0x49a6(_0x15d322,_0xd71883);}if(isBanned)return freply(mess[_0x3870c8(0x1d3)]);freply(_0x3870c8(0x1cd));
randommusic = fs.readFileSync(`./media/audio/${randomaudio}.mp3`)
...
//JASA RUN HEROKU
case 'jasarunheroku':
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/6285772674695?text=bang+mau+order+jasa+run+heroku`)
break
//JASA UP HEROKU
case 'jasaupgithub':
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/6285772674695?text=bang+mau+order+jasa+up+github:`)
break
//STORE MENU//
//TOP UP GAME
case 'topupgame2':

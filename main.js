...
function nocache(module, cb = () => { }) {
    console.log(color(`${spc2}           [ • CREATOR BY KubilBot • ]` ,`${randomcolors}`))
console.log(color(`${spc4}                       < ============================================ >`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Hai         : FahriBotz`, `${randomcolors}`))
...
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Owner       : Fahri Ofc`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Author      : BotolBotZ`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Recode     : FahriBotz`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Base Ori By : BotolBotZ`, `${randomcolors}`))
console.log(color(`${spc4}                       < ============================================ >`, `${randomcolors}`))
